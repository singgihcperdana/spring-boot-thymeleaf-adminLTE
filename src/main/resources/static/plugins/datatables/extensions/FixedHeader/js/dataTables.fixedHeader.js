...
/**
 * @summary     FixedHeader
 * @description Fix a tables's header or footer, so it is always visible while
 *              Scrolling
 * @version     2.1.2
...
FixedHeader.prototype = {
	 ...
	 * Purpose:  Clone the tables node and do basic initialisation
	 * Returns:  -
	 * Inputs:   -
	 */
	_fnCloneTable: function ( sType, sClass, fnClone, iCells )
	{
		...
		/* We know that the tables _MUST_ has a DIV wrapped around it, because this is simply how
		...
		/* Just a shallow clone will do - we only want the tables node */
		...
		/* Insert the newly cloned tables into the DOM, on top of the "real" header */
	...
	/*
	 * Function: _fnMeasure
	 * Purpose:  Get the current positioning of the tables in the DOM
	 * Returns:  -
	 * Inputs:   -
	 */
	_fnMeasure: function ()
	 ...
	 * Purpose:  Loop over the fixed elements for this tables and update their positions
	 * Returns:  -
	 * Inputs:   -
	 */
	 ...
	 * Purpose:  Loop over the fixed elements for this tables and call their cloning functions
	 * Returns:  -
	 * Inputs:   -
	 */
	...
	_fnCloneThead: function ( oCache )
	{
		...
		/* Set the wrapper width to match that of the cloned tables */
		var iDtWidth = $(s.nTable).outerWidth();
		oCache.nWrapper.style.width = iDtWidth+"px";
		nTable.style.width = iDtWidth+"px";

		/* Remove any children the cloned tables has */
	...
	/**
	 * Equalise the heights of the rows in a given tables node in a cross browser way. Note that this
